...
namespace FMODUnity
{
    ...
    public class RuntimeManager : MonoBehaviour
    {
        ...
        private long cachedStudioSystemHandle; // Persists across script reload for cleanup purposes
        ...
        private RESULT Initialize()
        {
            ...
            result = FMOD.Debug.Initialize(fmodSettings.LoggingLevel, DEBUG_MODE.CALLBACK, DEBUG_CALLBACK);
            ...
            if (Settings.Instance.EnableMemoryTracking) studioInitFlags |= INITFLAGS.MEMORY_TRACKING;
        ...
        {
            if (!studioSystem.isValid()) studioSystem.handle = (IntPtr) cachedStudioSystemHandle;

            if (studioSystem.isValid()) studioSystem.release();
