...
namespace GameJolt.API
{
	...
	public static class Sessions
    {
        ...
        {
            Request.Get(Constants.ApiSessionsOpen, null, response =>
            {
	    ...
	    public static void Ping(SessionStatus status = SessionStatus.Active, Action<bool> callback = null)
        {
            ...
            Request.Get(Constants.ApiSessionsPing, parameters, response =>
            {
                if (callback != null) callback(response.Success);
            });
        }
        ...
        {
            Request.Get(Constants.ApiSessionsClose, null, response =>
            {
                if (callback != null) callback(response.Success);
            });
        }
	    ...
	    public static void Check(Action<bool?> callback)
        {
            ...
            Request.Get(Constants.ApiSessionsCheck, null, response =>
            {
