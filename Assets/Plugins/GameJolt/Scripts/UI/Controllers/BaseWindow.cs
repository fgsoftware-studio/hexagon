...
namespace GameJolt.UI.Controllers
{
    public abstract class BaseWindow : MonoBehaviour
    {
        ...
        protected void Populate(RectTransform container, GameObject prefab, int count)
        {
            ...
            {
                var nbToCreate = count - container.childCount;
            ...
            {
                var nbToDelete = container.childCount - count;
                for (var i = 0; i < nbToDelete; ++i) DestroyImmediate(container.GetChild(0).gameObject);
            }
        }
    }
}