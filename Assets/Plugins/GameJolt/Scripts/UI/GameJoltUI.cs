...
namespace GameJolt.UI
{
    ...
    public class GameJoltUI : MonoSingleton<GameJoltUI>
    {
        #region Init
        ...
        protected override void Init()
        {
            ...
            notificationCentre = animator.GetBehaviour<NotificationCentre>();
        ...
        {
            var notification = new Notification(text, image);
            QueueNotification(notification);
        }
