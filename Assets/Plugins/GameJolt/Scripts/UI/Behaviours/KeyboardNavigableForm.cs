    ...
    public class KeyboardNavigableForm : StateMachineBehaviour
    {
        ...
        public override void OnStateEnter(Animator animator, AnimatorStateInfo animatorStateInfo, int layerIndex)
        {
            if (firstField == null)
            {
                ...
                if (firstFieldTransform != null) firstField = firstFieldTransform.GetComponent<InputField>();
            }

            if (submitButton == null)
            {
                var submitButtonTransform = animator.transform.Find(SubmitButtonPath);
                if (submitButtonTransform != null) submitButton = submitButtonTransform.GetComponent<Button>();
            }

            if (firstField != null) firstField.Select();
        }
        ...
        public override void OnStateUpdate(Animator animator, AnimatorStateInfo animatorStateInfo, int layerIndex)
        {
            ...
            if (Input.GetKeyDown(KeyCode.Return) || Input.GetKeyDown(KeyCode.KeypadEnter)) Submmit();
        }
